...
> **Estado Atual de Entrega:** [`docs/progress/CURRENT.md`](../progress/CURRENT.md)
...
- [ ] **Overhaul do Dourado e Esquadrão:** Minions dedicados, mecânicas de perseguição e fases escaladas ([`docs/specs/ready/overhaul-dourado-esquadrao.md`](../specs/ready/overhaul-dourado-esquadrao.md)).
...
### 3.1 Estado Atual ([`docs/specs/active/enemy-fsm-overhaul.md`](../specs/active/enemy-fsm-overhaul.md))
...
👉 **[`docs/planning/question-system-backlog.md`](question-system-backlog.md)**
...
👉 **[`docs/planning/audio-backlog.md`](audio-backlog.md)**
