...
- [ ] **Mega-pedido do usuário (VISUAL/GAMEPLAY/BARALHO/GERAL) dividido em 9 fases** — ver seção "Fases do mega-pedido" logo abaixo. Fases 1-7 feitas; Fase 8 pendente; Fase 9 (as "me dê ideias") só depois de tudo, por pedido explícito do usuário.
