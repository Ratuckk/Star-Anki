...
export const ROGUELIKE_CARDS = [
  ...
  // salva de orbes roxos homing; Status prolonga os dogfights da piloto.
  ...
  { id: 'miyu-boombuster', category: 'ofensivo', label: 'Miyu — Boombuster', icon: '🟣', description: 'Dispara orbes roxos homing de 3 dano contra até 1 + stacks alvos, a cada 10–4s.' },
