import { buildVisualSection, buildFogSection, buildArcadeSection, buildAudioSection, buildSensitivitySection, buildKeybindSection } from './hud-settings.js'
...
export function buildPauseOverlay(root) {
  ...
  function renderOptions() {
    ...
    scroll.appendChild(buildAudioSection())
