...
export const DEBUG_ACTIONS = [
  ...
  { id: 'spawnTimeEnemyMega', label: 'Spawnar ampulheta mega (10 hp, laser)' },
  { id: 'spawnDetrito', label: 'Spawnar detrito (obstáculo)' },
  { id: 'spawnSentinela', label: 'Spawnar sentinela (moldura)' },
  { id: 'spawnReplica', label: 'Spawnar réplica (eco fantasma)' },
  { id: 'spawnFragata', label: 'Spawnar fragata-escudo (arena)' },
  { id: 'spawnVerme', label: 'Spawnar verme-corrente' },
  { id: 'spawnImaSwarm', label: 'Spawnar enxame-ímã' },
  { id: 'spawnSussurro', label: 'Spawnar sussurro (invoca reforço)' },
