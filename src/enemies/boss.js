...
//
// A versão anterior empurrava o mesh lateralmente por um instante (offset = distância × tan
// do ângulo, com teto de 14u) e restaurava no fim do loop. Funcionava porque a ordem no
// frame era updateBossMovement → fire block → updateBossLaser, sem nenhuma leitura externa
// entre os passos — mas era frágil: no dia em que lockon do jogador ou spawn de minion lesse
// `enemy.mesh.position` nesse intervalo, o chefe aparecia teleportado por 1 frame.
